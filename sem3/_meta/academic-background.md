...
|------|------------------------|------------------------|
| Sem 1 | **EE** (barely passed) | Circuit basics, KVL/KCL, Thevenin — still shaky |
| Sem 2 | **EDC** (barely passed) | Weak diode/BJT/FET intuition → **ACD will feel hard** |
| Sem 2 | **NS** (barely passed) | If Network / systems — weak mesh/nodal, Laplace, filters |
| Summer | **Physics** (FF → cleared, ~5) | Vectors, fields, waves → **EMFT risk** |
| Sem 1 overall | ~5.9 CGPA | Need upward trend; Sem 3 target **SGPA 8+** |

## Strengths to lean on
- Computer / programming (10th, 12th IP, Sem 1 programming 9)
